...
Superpowers works natively on:
- **Windows** (native support, no Git Bash required)
- **macOS** (Intel and Apple Silicon)
- **Linux** (all distributions)

The plugin uses Node.js for cross-platform compatibility. Node.js is automatically available through Claude Code.
